...
(function () {
    ...
    function drawNeural() {
        ...
        nodes.forEach(n => {
            ...
            rg.addColorStop(0, n.col + glow * 1.0 + ')');
    ...
    function drawGD() {
        ...
        ctx.strokeStyle = C.accent + '0.8)'; ctx.lineWidth = 1.5; ctx.stroke();
        ...
        if (gdHistory.length > 1) {
            ...
            ctx.strokeStyle = C.accent + '0.45)'; ctx.lineWidth = 1; ctx.stroke();
        }
        ...
        ctx.strokeStyle = C.cyan + '0.85)'; ctx.lineWidth = 1.2; ctx.stroke();
        const ang = Math.atan2(y2 - y1, x2 - x1);
        ctx.beginPath();
        ctx.moveTo(x2, y2);
        ctx.lineTo(x2 - 6 * Math.cos(ang - 0.4), y2 - 6 * Math.sin(ang - 0.4));
        ctx.lineTo(x2 - 6 * Math.cos(ang + 0.4), y2 - 6 * Math.sin(ang + 0.4));
        ctx.closePath(); ctx.fillStyle = C.cyan + '0.85)'; ctx.fill();
    ...
    function drawLR() {
        ...
        lrPoints.forEach(p => {
            ...
            ctx.strokeStyle = C.purple + '0.65)'; ctx.lineWidth = 0.9; ctx.stroke();
        ...
        ctx.strokeStyle = C.accent + '0.9)'; ctx.lineWidth = 2; ctx.stroke();
    ...
    function drawEquations() {
        equations.forEach(eq => {
            ...
            const alpha = (0.5 + 0.5 * Math.sin(eq.phase)) * 0.55;
